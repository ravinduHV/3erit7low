...
class AwardProgressModel extends AwardProgressEntity {
  const AwardProgressModel({
    ...
    int? minMonthsAfterPrereqStarted,
    ...
    required bool isCompleted,
          ...
          minMonthsAfterPrereqStarted: minMonthsAfterPrereqStarted,
          startDateFollowsPrereq: startDateFollowsPrereq,
          startedAt: startedAt,
          completedAt: completedAt,
          groups: groups,
  ...
  factory AwardProgressModel.fromJson(Map<String, dynamic> json) {
    ...
    return AwardProgressModel(
      ...
      minMonthsAfterPrereqStarted: json['min_months_after_prereq_started'] as int?,
      startDateFollowsPrereq: (json['start_date_follows_prereq'] as bool?) ?? true,
